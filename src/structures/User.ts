...
class User extends RawUser {
    ...
    constructor(rawUser: RawUser) {
        ...
        this.avatarURL ? this.displayAvatarURL = this.avatarURL : this.displayAvatarURL = urls[parseInt(rawUser.discriminator.slice(3))] || urls[parseInt(rawUser.discriminator.slice(3)) - 5]
    }
}
export = User